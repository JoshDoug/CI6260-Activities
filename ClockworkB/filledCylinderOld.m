function [ cylinderTop, cylinderMiddle, cylinderBase ] = filledCylinderOld( radius, numSides, zHeights )
%FILLEDCYLINDEROLD Creates a solid cylinder (cylinder with a circle at top and base)
